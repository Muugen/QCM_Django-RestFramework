...
class Qcms(models.Model):
    
    class Meta:
        verbose_name =  _("Qcm") 
        verbose_name_plural = _("Qcms")
        ordering = ['id']
        
    title = models.CharField(max_length=255, default=_("New Qcm"), verbose_name=_("Qcm Title"))
...
class Question(Updated):
    ...
    qcm = models.ForeignKey(Qcms, related_name='question', on_delete=models.DO_NOTHING)
